...
# Option --patch-lv1-peek-poke: peek/poke support (unused lv1 calls 182 and 183/4.xx CFW)
# Option --patch-lv1-remove-lv2-protection: Remove LV2 protection (needed for 4.xx CFW)
...
namespace eval ::patch_lv1 {
    ...
    proc patch_elf {elf} {
        ...
        if {$::patch_lv1::options(--patch-lv1-remove-lv2-protection)} {
