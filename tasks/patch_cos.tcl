...
namespace eval ::patch_cos {
    ...
    proc main { } {
        ...
        if {$options(--patch-lv2-payload-hermes-4x)} {
    ...
    proc patch_self {self} {
        if {$options(--patch-lv0-coreos-ecdsa-check)} {
            ::modify_self_file $self ::patch_cos::patch_elf
        }
        
        if {$options(--patch-spkg-ecdsa-check)} {
            set self "spu_pkg_rvk_verifier"
            ::modify_self_file2 $self ::patch_cos::patch_elf
        }
        
        if {$options(--patch-appldr-fself-340) || $options(--patch-appldr-fself-330) || $options(--add-356keys-to-appldr341] || $options(--add-360keys-to-appldr355)} {
            set self "appldr"
            ::modify_self_file2 $self ::patch_cos::patch_elf
        }
        
        if {$options(--patch-profile-gameos-bootmem-size)} {
            set spp "default"
            ::modify_spp_file $spp ::patch_cos::patch_elf
        }
        
        if {$options(--patch-pup-search-in-game-disc) || !$options(--patch-gameos-hdd-region-size) == "" } {
            set self "emer_init"
            set size $options(--patch-gameos-hdd-region-size)
            ::modify_self_file2 $self ::patch_cos::patch_elf
        }
        
        if {$options(--patch-lv2-peek-poke-355) || $options(--patch-lv2-peek-poke-4x) } {
            ::check_task
            if {$lv1_task == 0} {
        ...
        if {!$options(--patch-lv2-peek-poke-355) && !$options(--patch-lv2-peek-poke-4x) && $options(--patch-lv2-lv1-peek-poke-355) || $options(--patch-lv2-lv1-call-355) ||  $options(--patch-lv2-payload-hermes-355) ||  $options(--patch-lv2-SC36-355) ||  $options(--patch-lv2-lv1-peek-poke-4x) ||  $options(--patch-lv2-npdrm-ecdsa-check) ||  $options(--patch-lv2-payload-hermes-4x) ||  $options(--patch-lv2-SC36-4x)} {
            set self "lv2_kernel"
            ::modify_self_file2 $self ::patch_cos::patch_elf
        }
    ...
    proc patch_elf {elf} {
        ...
        if {$options(--patch-appldr-fself-340)} {
        ...
        if {$options(--patch-appldr-fself-330)} {
        ...
        if {$options(--add-356keys-to-appldr341)} {
        ...
        if {$options(--add-360keys-to-appldr355)} {
        ...
        if {$options(--patch-pup-search-in-game-disc)} {
        ...
        if {$options(--patch-lv2-peek-poke-355)} {
        ...
        if {$options(--patch-lv2-lv1-peek-poke-355)} {
        ...
        if {$options(--patch-lv2-lv1-call-355)} {
        ...
        if {$options(--patch-lv2-payload-hermes-355)} {
        ...
        if {$options(--patch-lv2-peek-poke-4x)} {
        ...
        if {$options(--patch-lv2-lv1-peek-poke-4x)} {
        ...
        if {$options(--patch-lv2-npdrm-ecdsa-check)} {
